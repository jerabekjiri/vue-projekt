...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Pon 23. dub 2018, 12:25
...
CREATE TABLE IF NOT EXISTS `joined_meetups` (
  ...
  `meetup_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
(14, 'test', 'test@test.test', '', '', '$2y$10$4pt8IgGmqyDg1uJ281n.Pew.FjMH5FzO0a9J.qIBKFQ8r3n5h59Se', 'test');
